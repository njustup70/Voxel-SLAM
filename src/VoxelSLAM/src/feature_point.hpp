...
public:
  ...
  double process(const livox_ros_driver2::msg::CustomMsg &msg, pcl::PointCloud<PointType> &pl_full)
  {
    livox_handler(msg, pl_full);
    return rclcpp::Time(msg.header.stamp).seconds();
  }

  double process(const sensor_msgs::msg::PointCloud2 &msg, pcl::PointCloud<PointType> &pl_full)
  {
  ...
  void livox_handler(const livox_ros_driver2::msg::CustomMsg &msg, pcl::PointCloud<PointType> &pl_full)
  { 
  ...
  void velodyne_handler(const sensor_msgs::msg::PointCloud2 &msg, pcl::PointCloud<PointType> &pl_full)
  {
    pcl::PointCloud<velodyne_ros::Point> pl_orig;
    pcl::fromROSMsg(msg, pl_orig);

    int plsize = (int)pl_orig.size();
    if(plsize == 0) return;
  ...
  void ouster_handler(const sensor_msgs::msg::PointCloud2 &msg, pcl::PointCloud<PointType> &pl_full)
  {
    pcl::PointCloud<ouster_ros::Point> pl_orig;
    pcl::fromROSMsg(msg, pl_orig);

    int plsize = (int)pl_orig.points.size();
    pl_full.reserve(plsize);
    for(int i=0; i<plsize; i++)
    {
      PointType ap;
  ...
  void hesai_handler(const sensor_msgs::msg::PointCloud2 &msg, pcl::PointCloud<PointType> &pl_full)
  { 
  ...
  double robosense_handler(const sensor_msgs::msg::PointCloud2 &msg, pcl::PointCloud<PointType> &pl_full)
  {
  ...
  void tartanair_handler(const sensor_msgs::msg::PointCloud2 &msg, pcl::PointCloud<PointType> &pl_full)
  {
